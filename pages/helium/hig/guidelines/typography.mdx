...
| Display                | <span style="font-weight: 200;">Light 40px</span>             | `.display`               | Relatively large text on the screen, display is reserved for short, important text. |
| View Title             | <span style="font-weight: 200;">Light 32px</span>              | `.view-title`            | Used for view titles, it's big enough to title an app's view.                       |
