...
- Install [Docker](https://docs.docker.com/engine/install/). If on Linux, you will need to enable the service and restart your shell (reboot, logout, etc.).
- Fork the [Terra sources repo](https://github.com/terrapkg/packages), and then `git clone` your fork.
...
- Create a pull request that merges to the `frawhide` (effectivly the main) branch
