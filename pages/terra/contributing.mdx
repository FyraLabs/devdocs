...
- You are now ready for the Writing Sources section below.
...
- Assuming you are using Visual Studio Code, Open Visual Studio Code and navigate to the Extensions menu located at the bottom of the left hand side bar.
- Install the [Dev Containers](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers) extension.

- Fork the [Terra sources repo](https://github.com/terrapkg/packages), and then `git clone` your fork.
- Open this folder in Visual Studio Code (File -> Open Folder).
- It should prompt you to `reopen in Dev Container.` If not, press `Ctrl` + `Shift` + `P` and type `Open Folder in Container...` and select `Dev Container: Open Folder in Container...` and select your cloned Terra fork's folder.

- You are now in the Terra Dev Container.
- You now have all the packages and configuration necessary to start building packages!
...
1. Fork the [Terra sources repo](https://github.com/terrapkg/packages), and then `git clone` your fork.
...
- If needed (404 errors when buildong off `rawhide`, you can also modify the version it builds on (`43`, `43`, `el10`, etc.)
...
- Create a pull request that merges to the `frawhide` branch
