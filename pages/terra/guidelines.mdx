...
Try [`mold` linker](/terra/guidelines#usage-of-the-mold-linker).
Use [`%pkg_completion`](/terra/srpm#pkg_completion) for shell completions.

Use [`%pkg_devel_files`](/terra/srpm#pkg_devel_files), [`%pkg_libs_files`](/terra/srpm#pkg_libs_files), [`%pkg_static_files`]. See [Development and Shared Libraries](/terra/guidelines#development-and-shared-libraries) section.
...
Follow Fedora guidelines for interpreted (Python/Ruby) & dynamically (C/++) compiled langs.
