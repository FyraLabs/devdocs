...
It is RECOMMENDED to use the [`%_appsdir` macro](/srpm#_appsdir) from Anda SRPM instead of `%_datadir/applications/` and to use the [%desktop_file_install macro](/srpm#desktop_file_install).
