...
Before creating your `metainfo.xml` file, check out our [appstream helper macro](./#terra_appstream), as it can save a lot of effort.
...
If you do not know what the app ID of the package is, determine it using the [reverse domain name notation](https://en.wikipedia.org/wiki/Reverse_domain_name_notation).
