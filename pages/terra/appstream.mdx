...
All information is pulled from the Freedesktop specification, and each section links to it's Freedesktop page for more info.
...
You can also use this for libraries. More information on the `</provides>` tag can be found in the documentation [here](https://www.freedesktop.org/software/appstream/docs/chap-Metadata.html#tag-provides).

Basic `<provides>{:xml}` tag:
```xml
<provides>
