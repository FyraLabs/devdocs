...
Example usage:
```rpmspec
%desktop_file_edit -k Exec,Icon -v /usr/bin/pkg,pkgicon -u %u -f /path/to/file.desktop
```
...
Example usage:
```rpmspec
%desktop_file_install -k Exec,Icon -v /usr/bin/pkg,pkgicon -u %u -f path/to/file.desktop
```
