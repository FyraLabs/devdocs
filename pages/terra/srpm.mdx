...
| `%nim_tflags`                   |                                                                        |
| `%nim_lflags`                   |                                                                        |
| `%git_clone`                    | Downloads the source code via `git clone`                              |
| `%pkg_completion`               |                                                                        |
| `%pkg_devel_files`              |                                                                        |
| `%pkg_static_files`             |                                                                        |
...
| `%is_electron_bundled`          | Evaluation macro to expand later and a bcond for if Electron is bundled or not for meta/license macros |
| `%electron_arches`              | `%{x86_64} %{ix86} aarch64 armv7l armv7hl armv7hnl`                    |
| `%electron_license`             | Bundled licenses for pure electron programs                            |
| `%electronmeta`                 |                                                                        |
| `%npm_build`                    | npm build                                                              |
