...
<Callout>
  ...
  You SHOULD double check (/rpm/macro#regex-in-rpm) and on our page for macro syntax for more information on the regex format as RPM has some notable quirks with regex.
</Callout>
