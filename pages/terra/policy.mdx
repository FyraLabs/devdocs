...
All packages using interpreted languages follow the traditional Fedora guidelines. All dependencies **_must_** be packaged individually as they are considered runtime dependencies.
...
Check the [Rust section on the SRPM page](../SRPM) for more information on these macros.
