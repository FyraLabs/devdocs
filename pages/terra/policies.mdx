...
Additionally, all packages except libraries MUST provide an [AppStream metaInfo](https://www.freedesktop.org/software/appstream/docs/chap-Quickstart.html#qsr-app-example) file.
