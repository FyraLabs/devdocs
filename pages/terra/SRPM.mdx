...
## %electron_license
The license for bundled Electron. NOT set by default in `%electronmeta` because you cannot set the license field twice. MAY be used in combination with manually adding the other relevant licenses.
