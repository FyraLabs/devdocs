...
Which simply means Electron supports [x86_64](https://en.wikipedia.org/wiki/X86-64), [32-bit x86 (AKA: IA-32)](https://en.wikipedia.org/wiki/IA-32), [AArch64/ARM64](https://en.wikipedia.org/wiki/AArch64), (ARMv7)[https://en.wikipedia.org/wiki/ARM_architecture_family#Architecture_versions], and [MIPS64](https://en.wikipedia.org/wiki/MIPS_architecture).

However, at this time Terra only supports x86_64, AArch64, and 32-bit x86.

### Electron build macros
These are macros used to build software using Electron using JavaScript package managers.
