...
and the app was basically finished in early Jan, 2025.
...
Here is an example of the catalogue yml configuration file (taken from [here](https://github.com/Ultramarine-Linux/taidan/blob/208612f391c0f0f2a2cf3535f3341fb5a7e664c9/catalogue/browser.yml#L1-L29)):
...
strings. The app will be shown to systems with matching edition listed in this field.
...
`flatpak:...`, or a semicolon (`;`)-separated list of the above values, or `todo`.
