---
title: Install Arch Linux with Submarine
description: Install Arch Linux on a Chromebook using Submarine.
---
...
4. Write `submarine-<arch>.kpart` to the Submarine partition created in step 2.
...
5. Write `submarine-<arch>.kpart` to the Submarine partition.
