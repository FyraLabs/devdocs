---
title: Install NixOS with Submarine
description: Install NixOS on a Chromebook using Submarine.
---

<Callout type="info">
  While ARM images could technically be built aswell, they are not considered
  ready and therefore are not supported.
</Callout>

## Prepare an image

1. Either download a `raw-x64cros` image [from CI](https://github.com/ninelore/flake/actions/workflows/images.yml) or follow the [build instructions](https://github.com/ninelore/flake/blob/main/README.md#build-instructions)
