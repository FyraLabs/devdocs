---
title: Taidan
description: "Documentation for Taidan."
---
...
- Provide a catalogue of apps for the user to pick from
...
Taidan allows distributions to present "tweaks" as options to be presented to the user, in Ultramarine we use
