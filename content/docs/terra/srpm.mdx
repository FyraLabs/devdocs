...
For `%npm_build`, see [here](#npm_build).
...
For `%bun_build`, see [here](#bun_build).
...
For `%deno_build`, see [here](#deno_build).
...
For `%pnpm_build`, see [here](#pnpm_build).
...
For `%yarn_build`, see [here](#yarn_build).
