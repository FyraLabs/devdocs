...
Will require `BuildRequires: nodejs-npm`.
...
Will require `BuildRequires: bun-bin`.
...
Will require `BuildRequires: deno`.
...
Will require `BuildRequires: pnpm`.
...
You SHOULD use `BuildRequires: yarnpkg` (Yarn Classic) unless you need `BuildRequires: yarnpkg-berry` (Yarn Berry) specifically.
