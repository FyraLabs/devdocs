...
For `%npm_build{:rpmspec}`, see [here](#npm_build).
...
For `%bun_build{:rpmspec}`, see [here](#bun_build).
...
For `%deno_build{:rpmspec}`, see [here](#deno_build).
...
For `%pnpm_build{:rpmspec}`, see [here](#pnpm_build).
...
For `%yarn_build{:rpmspec}`, see [here](#yarn_build).
