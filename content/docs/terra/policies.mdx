...
Only [submit](/terra/policy#submission-policy) packages legally distributable, proprietary or not, but try not to PR same things (a) already in Fedora, & (b) WIP / untested code.
